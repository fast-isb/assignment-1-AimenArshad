...
export default function UpdateProfile() {
  ...
  const [password,setpassword] =useState(0);
    ...
    useEffect(()=>{
      (async ()=>{
        Axios.get('http://18.183.184.17:5000/api/Resident/get/3600000000').then((response)=> {
          setResident(response.data);
          
          });})();},[]);

     const updateUser=()=>{
            Axios.put(`http://18.183.184.17:5000/api/Resident/update/${resident.cnic}`,{password:password,fname: fname,lname:lname,age:age,email:email});
